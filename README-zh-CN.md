<div align="center">
    <img width="200" height="200" style="display: block; border: 1px solid #f5f5f5; border-radius: 9999px;" src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/icon.png">
</div>
...
<div align="center">
    ...
    <a target="_blank" href="https://github.com/RBWare/Legens/blob/main/README.md">English</a>&nbsp;&nbsp;|&nbsp;&nbsp;
    <a target="_blank" href="https://github.com/RBWare/Legens/blob/main/README-de.md">Deutsch</a>&nbsp;&nbsp;|&nbsp;&nbsp;
    简体中文&nbsp;&nbsp;|&nbsp;&nbsp;
    ...
    <br/>
    <br/>
    <img src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/phoneScreenshots/startup.png" width="19.2%"alt="startup" />
    <img src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/phoneScreenshots/feeds.png" width="19.2%" alt="feeds" />
    <img src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/phoneScreenshots/flow.png" width="19.2%" alt="flow" />
    <img src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/phoneScreenshots/read.png" width="19.2%" alt="read" />
    <img src="https://raw.githubusercontent.com/RBWare/Legens/main/fastlane/metadata/android/zh-CN/images/phoneScreenshots/settings.png" width="19.2%" alt="settings" />
    <br/>
    <br/>
</div>
...
**Legens** 是一个以 [Material You](https://m3.material.io/) 风格呈现的 Android RSS 阅读器，这些是目前已完成的功能和未来要做的事。
...
**Legens** 也集成了一些第三方服务 API，支持您使用已有的云端账户来作为数据源。
...
[<img src="https://s1.ax1x.com/2023/01/12/pSu1a36.png" alt="Get it on GitHub" height="80">](https://github.com/RBWare/Legens/releases)
...
<a target="_blank" href="https://github.com/RBWare/Legens/actions/workflows/build_commit.yaml">检查夜间构建</a>
...
**Legens** 是一款免费的自由开源软件，它受益于开源社区，每一位用户都能够免费享受到它完整的功能，如果您赞赏我目前的工作，可以选择请我喝一杯咖啡 ☕️。
...
感谢每一位 **Legens** 的翻译人员，如果您也希望做出贡献，请通过 [Weblate](https://hosted.weblate.org/engage/readyou/) 来提交翻译文本。

[<img src="https://hosted.weblate.org/widgets/readyou/-/horizontal-auto.svg" alt="" />](https://hosted.weblate.org/engage/readyou/)

## 构建

> 欢迎 [提交](https://github.com/RBWare/Legens/pulls) 您的代码，[GitHub Actions](https://github.com/RBWare/Legens/actions) 为每次提交都自动打包了所有分发渠道的 APK 文件。

**Legens** 基于 [Jetpack Compose](https://developer.android.com/jetpack/compose) 工具包来构建 Android 原生用户界面。

1. 首先您需要获取 **Legens** 的源代码：
...
感谢 **@Kyant0** 为 **Legens** 提供的设计灵感与 Monet 引擎实现。
